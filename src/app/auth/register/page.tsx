    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-6 transition-colors duration-300">
        <motion.div 
          ...
          className="max-width-md w-full bg-card border border-border p-10 rounded-[40px] text-center space-y-6 shadow-sm"
        >
          <div className="w-20 h-20 bg-green-500/10 rounded-full flex items-center justify-center mx-auto text-green-500">
            <CheckCircle className="w-10 h-10" />
          </div>
          <h2 className="text-3xl font-bold text-foreground">Cek Email Anda!</h2>
          <p className="text-muted-foreground">
            Kami telah mengirimkan link verifikasi ke <strong className="text-foreground">{email}</strong>. Silakan verifikasi akun Anda sebelum login.
          </p>
          <button 
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden transition-colors duration-300">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold mb-2 text-foreground">Buat Akun Baru</h1>
          <p className="text-muted-foreground">Mulai perjalanan konten viral Anda</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-muted-foreground">
          Sudah punya akun?{" "}
          <a href="/auth/login" className="text-primary hover:underline font-bold">Login di sini</a>
        </p>
      </motion.div>
    </div>
  );
